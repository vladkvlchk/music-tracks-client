...
export function EditTrackModal({
  ...
  const onSubmit = async (data: EditFormValues) => {
    ...
    try {
      ...
      toast.custom(() => (
        <ToastSuccess title="Success" message="Track updated successfully" />
      ));
      onUpdated();
    } catch (error) {
      toast.custom(() => (
        <ToastError title="Error" message="Failed to update track. Please try again." />
      ));
    } finally {
